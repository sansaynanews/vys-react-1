...
import EvrakTable from "@/components/evrak/EvrakTable";
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-slate-900 via-blue-900 to-slate-900 animate-gradient-x rounded-2xl p-6 shadow-2xl border border-white/5">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-xs font-medium text-white/80">Elektronik Belge</span>
          </div>
          <h1 className="text-xl lg:text-2xl font-bold text-white">Evrak Takip</h1>
          <p className="text-sm text-slate-400 mt-1 max-w-2xl">
            Gelen ve giden evrakların kaydı, havalesi ve arşivlenmesi.
          </p>
        </div>
