...
import KonusmaTable from "@/components/konusma-metinleri/KonusmaTable";
import { Sparkles, Mic2 } from "lucide-react";

export default function KonusmaMetinleriPage() {
    return (
            ...
            <div className="relative overflow-hidden bg-gradient-to-r from-slate-900 via-blue-900 to-slate-900 animate-gradient-x rounded-2xl p-6 shadow-2xl border border-white/5">
                ...
                <div className="relative z-10">
                    <div className="flex items-center gap-2 mb-1">
                        ...
                        <span className="text-xs font-medium text-white/80">Basın ve Yayın</span>
                    </div>
                    <h1 className="text-xl lg:text-2xl font-bold text-white">Konuşma Metinleri</h1>
                    <p className="text-sm text-slate-400 mt-1 max-w-2xl">
                        Resmi program ve törenler için hazırlanan konuşma metinleri arşivi.
                    </p>
                </div>
